      ...
      <div className="__btn_container flex gap-1">
        <Dialog>
          <DialogTrigger asChild>
            <Button className="flex justify-center item-center gap-1" variant="success" size="icon" loading={isLoading}>
              <Save size={16} />
            </Button>
          </DialogTrigger>
          <DialogContent>
        ...
        <Button className="flex justify-center item-center gap-1" onClick={handleDownloadCode} size="icon" variant="blue">
          <Download size={16} />
        </Button>
